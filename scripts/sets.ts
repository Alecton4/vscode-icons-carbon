...
export const sets: IconSet[] = [
  {
    ...
    icons: {
      ...
      'codicon:organization': 'bi:people',
      'codicon:organization-filled': 'bi:people-fill',
      'codicon:organization-outline': 'bi:people',
      ...
      'codicon:person': 'bi:person',
      'codicon:person-add': 'bi:person-add',
      'codicon:person-filled': 'bi:person-fill',
      'codicon:person-follow': 'bi:person-check',
      'codicon:person-outline': 'bi:person',
      // 'codicon:pin': 'carbon:',
