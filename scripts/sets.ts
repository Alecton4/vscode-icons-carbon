...
export const sets: IconSet[] = [
  {
    ...
    icons: {
      ...
      'codicon:package': 'mdi:package-variant',
      ...
      'codicon:symbol-boolean': 'mdi:toggle-switch-off-outline',
      ...
      'codicon:symbol-field': 'mdi:cube-outline',
      // 'codicon:symbol-file': 'carbon:document-blank',
      // 'codicon:symbol-folder': 'carbon:folder',
      'codicon:symbol-function': 'mdi:function-variant',
      'codicon:symbol-interface': 'mdi:connection',
      ...
      'codicon:symbol-module': 'mdi:package-variant',
      ...
      'codicon:symbol-package': 'mdi:package-variant',
      ...
      'codicon:symbol-snippet': 'mdi:application-brackets-outline',
      ...
      'codicon:symbol-value': 'mdi:variable',
      'codicon:symbol-variable': 'mdi:cube-scan',
      // 'codicon:sync': 'carbon:',
      ...
      'codicon:variable': 'mdi:cube-scan',
